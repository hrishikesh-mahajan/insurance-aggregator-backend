...
class AdvancedClaimVerificationService:
    def __init__(self, input_directory: str, output_directory: str):
        ...
        self.gemini_pro_model = genai.GenerativeModel("gemini-1.5-flash")
    ...
    def generate_comprehensive_report_with_gemini(
        self, json_contents: Dict[str, Any]
    ) -> str:
        """
        ...
        try:
            ...
            Analyze the following semi-structured JSON data generated by services like EXIF extraction tool for GPS Co-ordinates and Timestamp verification, Disaster Reports from Known Genuine Sources, and Cohesiveness and Fradulent detection using NLP and AI. Generate a comprehensive,structured markdown report that includes:

            1. Detailed overview of the claim
            2. Comprehensive analysis of reports from inyternal verification tools
            3. Key findings and insights
            4. Potential red flags or inconsistencies
            5. Recommendation for claim processing
            6. Finally, highlight Accept/Reject decision based on the analysis in visually appealing format.
            7. Remeber the json files provided have accurate data, whike referring mention that in verification stage as stated above.
            8. Do notinclude json file names, only utilize the data.
    ...
    def run_verification(self):
        ...
        try:
            ...
            markdown_report = self.generate_comprehensive_report_with_gemini(
                json_contents
            )

            # Generate PDF report
            output_filename = (
                f'claim_verification_{datetime.now().strftime("%Y%m%d_%H%M%S")}.pdf'
            )
...
def main():
    verification_service = AdvancedClaimVerificationService(
        input_directory="./output", output_directory="./reports"
    )
